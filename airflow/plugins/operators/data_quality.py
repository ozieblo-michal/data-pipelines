...
class DataQualityOperator(BaseOperator):
    ...
    Passing test query and expected result.
    
    Parameters:
    expected_result -> Expected result to match against result of test_query
    redshift_conn_id -> Redshift connection ID
    test_query -> SQL query to run on Redshift data warehouse
    """
